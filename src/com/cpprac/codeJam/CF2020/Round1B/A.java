package com.cpprac.codeJam.CF2020.Round1B;
...
public class A {
    ...
    private boolean dfs(long xi, long yi, long x, long y, int i, long totalSum) {
        ...
        if ( (i != 0 || x % 2 != 0) && !visited.containsKey(new Pair(xi + next(i + 1), yi)) ) {
            sb.append("E");
        ...
        if ( (i != 0 || y % 2 != 0) && !visited.containsKey(new Pair(xi, yi - next(i + 1))) ) {
            sb.append("S");
